...
(function($) {
	...
	$.Poshytip = function(elm, options) {
		...
		this.$tip = $(['<div class="',this.opts.className,'">',
				...
				'<div><div class="tip-arrow tip-arrow-top tip-arrow-right tip-arrow-bottom tip-arrow-left"></div></div>',
	...
	$.Poshytip.prototype = {
		...
		refresh: function(async) {
			...
			if (arrow && this.pos.arrow) {
                ...
                this.$arrow.css('margin-left', this.tipOuterW/2-8+'px');
			}
